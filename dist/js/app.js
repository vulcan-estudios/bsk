...
},{"./bootstrap":4,"./bsk/App":5,"./bsk/AppLoader":7,"./libs/underscore/settings":50,"helpers/events/events":19}],4:[function(require,module,exports){
'use strict';
...
},{"../config/config":11,"./AppLoader":7,"./AppModel":8,"./AppRouter":9,"./AppView":10,"helpers/flash/flash":23,"helpers/form/form":29,"helpers/modal/modal":36,"libs/Api":40,"libs/Storage":41,"libs/filter/Filter":42}],6:[function(require,module,exports){
'use strict';
...
},{"../models/Example.js":53}],9:[function(require,module,exports){
'use strict';
...
module.exports = {
    ...
    Run: function Run() {
        ...
        $('body').attr('data-module', this.module).attr('data-controller', this.controller).attr('data-action', this.action);
    ...
    SubView: function SubView(view, options) {

        var subview = options.view || {};
...
},{"../views/_shared/partials/folder/test3.html":54,"../views/_shared/partials/test1.html":55,"../views/_shared/partials/test2.html":56,"../views/_shared/partials/test4.html":57,"../views/home/index.js":58,"../views/home/list.js":59,"../views/main.js":62,"../views/notifications/users/index.js":63}],11:[function(require,module,exports){
'use strict';
...
module.exports = {
    ...
    init: function init(cb) {
        ...
        var $input = $('body').find(':input:visible').not('readonly').not('disabled').first();
        setTimeout(function () {
            $input.trigger('focus');
...
module.exports = {
    ...
    bind: function bind(element) {
        ...
        $(element).not('[data-plugin-loaded]').each(function () {
            ...
            var $input = $(this);
            var tag = $input.data('select-tag') !== undefined;
            var url = $input.data('select-url');
            var urlParams = $input.data('select-params') || {};
            var text = $input.data('select-text') || 'name';
            var key = $input.data('select-key') || 'id';
...
},{"./templates/basic.html":37,"./templates/confirm.html":38,"./templates/filter-date.html":39,"helpers/form/bind":25,"libs/zurb/Zurb":51}],37:[function(require,module,exports){
...
},{"libs/polyfills/localStorage":48}],42:[function(require,module,exports){
"use strict";
...
},{"./filters/ltrimFilter.js":43,"./filters/prefixFilter.js":44,"./filters/rtrimFilter.js":45,"./filters/suffixFilter.js":46,"./filters/trimFilter.js":47}],43:[function(require,module,exports){
"use strict";
...
},{"../../config/config":11,"./mixing":49}],51:[function(require,module,exports){
'use strict';
...
},{"libs/zurb/components/abide":52}],52:[function(require,module,exports){
'use strict';
...
},{"./templates/index.html":60}],59:[function(require,module,exports){
'use strict';
...
},{"./templates/list.html":61}],60:[function(require,module,exports){
...
},{"helpers/form/bind":25,"libs/zurb/Zurb":51}],63:[function(require,module,exports){
'use strict';
...
},{"./templates/index.html":64}],64:[function(require,module,exports){
