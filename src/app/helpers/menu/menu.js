...
module.exports = function () {
     ...
     * Toggles the submenu
     */
    Menu.prototype._initToggleSubmenu = function() {

        // Check submenu opened
    ...
    Menu.prototype._toggleMenuOn = function () {
        ...
        this.body.classList.add("md-menu-open");
        this.wrapper.classList.add("md-menu-open");
    ...
    Menu.prototype._toggleMenuOff = function () {
        ...
        this.body.classList.remove("md-menu-open");
        this.wrapper.classList.remove("md-menu-open");
    ...
    Menu.prototype._touchEffectHandler = function (menuItemLink) {
        ...
        touchEffectElement.className = "md-menu__link--touch-effect";
